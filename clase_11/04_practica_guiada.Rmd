...
```{r}
rt %>% 
  select(-c(starts_with('quote'), starts_with('retweet'), starts_with('place'), starts_with('url'), starts_with('ext'), starts_with('media'), starts_with('reply'), starts_with('profile'))) %>% 
glimpse()
```
...
- Primero creo un objeto de tipo Corpus.
```{r}
